...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'ClassList', fields ['class_number']
        db.create_unique('classlist_classlist', ['class_number'])
    
    
    def backwards(self, orm):
        
        # Removing unique constraint on 'ClassList', fields ['class_number']
        db.delete_unique('classlist_classlist', ['class_number'])
