...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        instructors = orm['auth.Group'].objects.create(name="instructors")
        tutors = orm['auth.Group'].objects.create(name="tutors")
        instructors.permissions.add(orm['auth.Permission'].objects.get(codename="change_classlist"))
        instructors.permissions.add(orm['auth.Permission'].objects.get(codename="change_classtutor"))
        instructors.permissions.add(orm['auth.Permission'].objects.get(codename="delete_classtutor"))
        instructors.permissions.add(orm['auth.Permission'].objects.get(codename="change_project"))
        tutors.permissions.add(orm['auth.Permission'].objects.get(codename="change_project"))

    def backwards(self, orm):
        "Write your backwards methods here."
        orm['auth.Group'].objects.all().delete()
    ...
    models = {
        ...
        'classlist.classtutor': {
            'Meta': {'object_name': 'ClassTutor'},
