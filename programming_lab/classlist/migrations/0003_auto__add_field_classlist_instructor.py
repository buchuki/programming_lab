...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ClassList.instructor'
        db.add_column('classlist_classlist', 'instructor', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='instructed_classes', null=True, to=orm['auth.User']), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'ClassList.instructor'
        db.delete_column('classlist_classlist', 'instructor_id')
