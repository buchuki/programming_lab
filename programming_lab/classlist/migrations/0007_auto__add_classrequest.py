...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ClassRequest'
        db.create_table('classlist_classrequest', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('classlist', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['classlist.ClassList'])),
            ('status', self.gf('django.db.models.fields.CharField')(default='pending', max_length=16)),
        ))
        db.send_create_signal('classlist', ['ClassRequest'])


    def backwards(self, orm):
        
        # Deleting model 'ClassRequest'
        db.delete_table('classlist_classrequest')
