...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ClassTutor'
        db.create_table('classlist_classtutor', (
        ...
        db.send_create_signal('classlist', ['ClassTutor'])


    def backwards(self, orm):
        
        # Deleting model 'ClassTutor'
        db.delete_table('classlist_classtutor')
