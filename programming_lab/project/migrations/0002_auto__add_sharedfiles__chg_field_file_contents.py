...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'SharedFiles'
        db.create_table('project_sharedfiles', (
            ('shared_on', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('file', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['project.File'])),
            ('shared_with', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal('project', ['SharedFiles'])

        # Changing field 'File.contents'
        db.alter_column('project_file', 'contents', self.gf('django.db.models.fields.TextField')(blank=True))
    
    
    def backwards(self, orm):
        
        # Deleting model 'SharedFiles'
        db.delete_table('project_sharedfiles')

        # Changing field 'File.contents'
        db.alter_column('project_file', 'contents', self.gf('django.db.models.fields.TextField')())
