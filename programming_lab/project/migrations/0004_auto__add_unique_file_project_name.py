...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'File', fields ['project', 'name']
        db.create_unique('project_file', ['project_id', 'name'])
    
    
    def backwards(self, orm):
        
        # Removing unique constraint on 'File', fields ['project', 'name']
        db.delete_unique('project_file', ['project_id', 'name'])
